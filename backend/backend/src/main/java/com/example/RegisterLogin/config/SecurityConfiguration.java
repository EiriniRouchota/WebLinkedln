    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/employee/auth/**", "/api/v1/employee/login", "/api/v1/employee/save","api/institutions/*", "api/skills/*").permitAll() // Allow these endpoints without authentication
